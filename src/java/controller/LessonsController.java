...
public class LessonsController implements Serializable {
    ...
    @EJB
    private facade.LessonsFacade ejbFacade;
	...
	try {
	    ...
	    JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle/Lessons").getString("LessonsCreated"));
	    return prepareCreate();
	} catch (Exception e) {
	    JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle/Lessons").getString("PersistenceErrorOccured"));
	    return null;
	}
    }
	...
	try {
	    ...
	    JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle/Lessons").getString("LessonsUpdated"));
	    return "View";
	} catch (Exception e) {
	    JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle/Lessons").getString("PersistenceErrorOccured"));
	    return null;
	...
	try {
	    ...
	    JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle/Lessons").getString("LessonsDeleted"));
	} catch (Exception e) {
	    JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle/Lessons").getString("PersistenceErrorOccured"));
	}
    }
